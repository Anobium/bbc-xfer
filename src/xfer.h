#ifndef XFER_H
#define XFER_H
/* $Id: xfer.h,v 1.10  2005/01/16 10:47:53  jon Exp $
 *
...
#include <sys/types.h>
#include <fcntl.h>
#include <unistd.h> /* getcwd, chdir, mkdir, sleep */
#endif /* _WIN32 */
...
#define BBCADFSTRACKSIZE 4096   /* Number of bytes in a standard ADFS BBC track */
...
/* Handshake methods. Only CTS/RTS and DSR/DTR are currently supported. */
typedef enum {
...
bbc_status_t bbc_readline(serial_h connection, char *buffer, long size) ;
bbc_status_t bbc_read(serial_h connection, char *buffer, long *size) ;
...
void default_configuration(configuration_t *config, char *home) ;
...
/*
 * $Log: xfer.h,v $
 * Revision 1.11  2005/01/22 08:27:39  jon
 * Added support for transferring disc images back from PC to BBC
 *
 * Revision 1.10  2005/01/16 10:47:53  jon
 * Added ADFS support
 *
